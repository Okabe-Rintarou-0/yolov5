...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='runs/train/exp6/weights/best.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/myYaml.yaml', help='data.yaml path')
